...
?>
<div class="campaign-raised campaign-summary-item campaign-raised-circle-counter campaign-raised-counter et_pb_circle_counter container-width-change-notify et_pb_module et_pb_bg_layout_light et_pb_circle_counter_0">
    <div class="et_pb_circle_counter_inner" data-number-value="<?php echo esc_attr( $value ) ?>" data-bar-bg-color="<?php echo charitable_get_option( 'highlight_colour', '#2ea3f2' ) ?>">
