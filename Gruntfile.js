...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        sass: {
            dist: {
                files: {
                    'assets/css/charitable-divi.css' : 'assets/css/scss/charitable-divi.scss'
                }
            }
        },
        ...
        makepot: {
            target: {
                options: {
                    ...
                    exclude: ['build/.*'],
                    mainFile: 'charitable-divi.php',    // Main project file.
                    potFilename: 'charitable-divi.pot',    // Name of the POT file.
                    potHeaders: {
